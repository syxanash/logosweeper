    ...
    if (gameover) {
      return (
        <Fieldset>
          ...
          <Button size='lg'>
            <Anchor style={{textDecoration: 'none'}} href={`https://twitter.com/intent/tweet?text=I%20just%20guessed%20${score}%20logos%20in%20a%20row%20on%20https%3A%2F%2Fquizlogo.surge.sh%20%F0%9F%8E%AF`} target='_blank'>
